...
import bike.car.rent.Models.UserDetails;
...
public class SignUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> adapter1=ArrayAdapter.createFromResource(getApplicationContext(), R.array.city, android.R.layout.simple_spinner_dropdown_item);
        ...
        generateOTPBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(edtPhone.getText().toString()) || TextUtils.isEmpty(edtEmail.getText().toString()) ||
                        TextUtils.isEmpty(edtName.getText().toString()) ||TextUtils.isEmpty(city.getSelectedItem().toString()) ||TextUtils.isEmpty(edtPhone.getText().toString())) {
    ...
    private void verifyCode(String code) {
        ...
        String Address = city.getSelectedItem().toString().trim();
    ...
    public void sendEmail(){
        ...
        try {
            String stringSenderEmail = "makeinindia247@gmail.com";
            String stringReceiverEmail = edtEmail.getText().toString();
            String stringPasswordSenderEmail = "dygpevauqaowouqj";
            ...
            mimeMessage.setSubject("Bike Car Rent Registration");
            mimeMessage.setText("Hello "+ edtName.getText().toString()+"\nYou have successfully registered in Bike Car Rent.");
